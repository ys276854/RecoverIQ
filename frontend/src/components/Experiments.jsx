    ...
    <div className="space-y-6">
      ...
      <div className="p-4 bg-slate-900 border border-slate-800 rounded-xl text-xs font-sans text-slate-300 space-y-1">
        ...
        <p className="text-slate-300 font-sans leading-relaxed text-[12px] pl-6">
          <strong>Provenance Statement:</strong> All benchmark metrics below (e.g. +28.5% Net Recovery Lift, 83.2% cost savings, 87.5% friction reduction) are <strong>controlled offline counterfactual evaluation results</strong> generated by backtesting the calibrated policy on held-out test sets from the Olist E-Commerce (99,441 orders) and Hillstrom RCT (64,000 customers) datasets. They represent rigorous offline backtest projections and are <em>not claimed as live Razorpay production merchant volume</em>.
        </p>
      </div>
